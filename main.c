...
int main() {
    ...
    while (1) {
        ...
        else if (strcmp(option_buffer, "5") == 0) { // delete by location
            char location_buffer[64];
        ...
        else if (strcmp(option_buffer, "6") == 0) { // delete by username
            char location_buffer[64];
            char username_buffer[1024];
        ...
        else if (strcmp(option_buffer, "7") == 0) {
            char location_buffer[64];
            char username_buffer[1024];
        ...
        else if (strcmp(option_buffer, "help") == 0) { // help
            printf("-------------Citadel Password Manager-------------\n");
            printf("[1] Search All\n");
            printf("[2] Search By Location\n");
            printf("[3] Search By Username\n");
